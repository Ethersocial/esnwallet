...
gulp.task('update-nodes', (cb) => {
    ...
    got('https://www.ethersocial.net/download/releases_latest.json', { json: true })
    .then((response) => {
    ...
    .then((tagName) => {
        ...
        if (cmp(latestGethVersion, localGethVersion)) {
            ...
            got(`https://www.ethersocial.net/download/commits_${tagName}.json`, { json: true })
            .then((response) => {
            ...
            .then((hash) => {
                ...
                got('https://www.ethersocial.net/download/builds_list.xml', { xml: true })
                .then((response) => {
