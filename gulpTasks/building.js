...
gulp.task('copy-build-folder-files', () => {
    return gulp.src([
        `./icons/${type}/*`,
        './interface-dapp/public/images/dmg-background.jpg'
    ])
...
gulp.task('bundling-interface', (cb) => {
    ...
    console.log('Use local wallet at ../interface-dapp');
    bundle(`&& cd ../interface-dapp \
    ...
    //             // console.log(`Pulling https://github.com/ethersocial/meteor-dapp-wallet/tree/${options.walletSource} "${options.walletSource}" branch...`);
...
gulp.task('build-dist', (cb) => {
    const appPackageJson = _.extend({}, require('../package.json'), {  // eslint-disable-line global-require
        ...
        homepage: 'https://github.com/ethersocial/ethersocialwallet',
        build: {
