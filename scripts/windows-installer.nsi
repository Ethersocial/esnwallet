...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gesc incoming peers (TCP:50505)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gesc\unpacked\gesc.exe" "" "" "EtherSocial" 50505 "" "" ""
    #SimpleFC::AdvAddRule "Gesc outgoing peers (TCP:50505)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gesc\unpacked\gesc.exe" "" "" "EtherSocial" "" 50505 "" ""
    #SimpleFC::AdvAddRule "Gesc UDP discovery (UDP:50505)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gesc\unpacked\gesc.exe" "" "" "EtherSocial" "" 50505 "" ""
